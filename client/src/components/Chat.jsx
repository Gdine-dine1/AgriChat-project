          ...
          {Object.entries(groupedMessages).map(([label, msgs]) => (
            <div key={label}>
              <div className="text-center my-2">
                <span className="bg-green-200 text-green-900 px-3 py-1 rounded-full text-xs shadow-sm">{label}</span>
              </div>
              {msgs.map((msg) => {
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center mt-1 text-[10px]">
                        ...
                        {isOwn ? (
                          ...
                          <button onClick={() => setReplyTo(msg)} className="text-green-600 hover:underline ml-auto">
                            Reply
                          </button>
                        )}
                      </div>
